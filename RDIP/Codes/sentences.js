...
function newsentence(k)
    {
        ...
        if (count === len) {
        document.getElementById("check").innerHTML ="<center><button >Check the correctness</button></center>"
        document.getElementById("getthecorrectsen").innerHTML = "<center><button id='showansbtn' onclick='gets()'>Get Correct Sentence</button></center>";
...
function reformsen() 
 ...
 function compares(){
        var form=document.getElementById("bee").value;
        var str= form.trim();
